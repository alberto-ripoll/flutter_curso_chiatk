...
class AddRecipePage extends StatefulWidget {
  ...
  final Recipe recipe;
  AddRecipePage(this.serverController, {key, required this.recipe})
      : super(key: key);
...
class _AddRecipePageState extends State<AddRecipePage> {
  ...
  void _ingredientDialog(BuildContext context, int index, {String? ingredient}) {
  ...
  void _stepDialog(BuildContext context,int index, {String? step}) {
  ...
  void _onIngredientEdit(int index) {
    final ingredient = ingredientsList[index];
    _ingredientDialog(context, index, ingredient: ingredient);
  }
  ...
  void _onStepEdit(int index) {
    ...
    _stepDialog(context, index, step: step);
  }
